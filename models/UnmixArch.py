...
from .common import conv, Concat, bn, act
...
def UnmixArch(
    ...
    if not (isinstance(upsample_mode, list) or isinstance(upsample_mode, tuple)) :  #在干嘛？
    ...
    for i in range(len(num_channels_down)):  #i=0
